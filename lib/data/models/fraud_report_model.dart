...
class FraudReportModel {
  ...
  factory FraudReportModel.fromJson(Map<String, dynamic> json) => _$FraudReportModelFromJson(json);
  Map<String, dynamic> toJson() => _$FraudReportModelToJson(this);

  factory FraudReportModel.fromFirestore(DocumentSnapshot doc) {
    final data = doc.data() as Map<String, dynamic>;
    return FraudReportModel.fromJson({
      'id': doc.id,
      ...data,
  ...
  @override
  String toString() {
    return 'FraudReportModel{id: $id, type: $type, status: $status, severity: $severity}';
  }
}
